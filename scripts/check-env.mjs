...
const REQUIRED = [
  ...
  // Phase F — token encryption for Firestore-synced OAuth.
  // Without this, OAuth succeeds but the heartbeat never sees the token.
  // Generated by install.sh on the VM; operator copies to .env.local.
